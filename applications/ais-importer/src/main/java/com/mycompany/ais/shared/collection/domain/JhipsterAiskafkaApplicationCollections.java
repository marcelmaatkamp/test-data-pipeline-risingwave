package com.mycompany.ais.shared.collection.domain;
 ...
 */
public final class JhipsterAiskafkaApplicationCollections {

  private JhipsterAiskafkaApplicationCollections() {}
